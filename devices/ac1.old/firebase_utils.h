...
void streamCallback(StreamData data)
{
  ...
  Serial.println("KURVO!");
  //  Serial.println("Stream Data...");
  //  Serial.println(data.streamPath());
  //  Serial.println(data.dataPath()); // /swing
  //  Serial.println(data.dataType());
  //  Serial.println(data.jsonString()); // true
  Serial.println("EDNA!");
  ...
  Serial.println(len);
  String key, value = "";
  Serial.println("MAJUKAFKODSJKAO");
  int type = 0;
  for (size_t i = 0; i < len; i++)
  {
    json->iteratorGet(i, type, key, value);
    Serial.println("ABE AJDE");
    if (key == "power") {
